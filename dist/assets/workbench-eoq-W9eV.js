import{n as m,S as p,m as r,T as c,$ as g,L as x}from"./index-DrRY-Jl8-DrRY-Jl8-gkoO4HHx.js";window.__WC_TEMPLATES__=m;p("workbench");const h=document.getElementById("app"),l=r.get(),f=(l.favs||[]).map(c).filter(Boolean),v=(l.history||[]).map(c).filter(Boolean),d=l.shares||[];function n(e,s,t){return s.length?`<div class="mb-10"><h2 class="text-xl font-bold mb-4">${e} <span class="text-sm font-normal text-slate-400">(${s.length})</span></h2>
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">${s.map(a=>x(a,{fav:!0,from:"workbench"})).join("")}</div></div>`:`<div class="mb-10"><h2 class="text-xl font-bold mb-4">${e}</h2><p class="text-slate-400 text-sm">${t}</p></div>`}function y(e){return`
