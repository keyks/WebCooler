import{n as a,S as o,p as n,q as i,L as s,T as r,A as c,$ as x}from"./index-DrRY-Jl8-DrRY-Jl8-gkoO4HHx.js";window.__WC_TEMPLATES__=a;o("");const m=document.getElementById("app"),b=`
...
<section class="max-w-7xl mx-auto px-4 mb-16">
  ...
  <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    ${n.map(t=>{const l=a.filter(d=>d.cat===t.id).length;return`<a href="categories.html?cat=${t.id}" class="wc-card p-5 hover:-translate-y-1 group">
