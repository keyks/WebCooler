...
<section class="relative overflow-hidden">
  ...
  <div class="relative max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
    ...
    <p class="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-8">最全、最新、可直接复制、可在线预览、可一键下载的布局 / 动态效果 / 鼠标 & 键盘交互 / 文本美化 / 组件库一站式平台。共 <b class="text-brand-600 dark:text-brand-300">${TEMPLATES.length}</b> 个真实可运行模板。</p>
